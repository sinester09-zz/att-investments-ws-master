...
public class FileResource {
	...
	private static final Logger logger = LoggerFactory.getLogger(FileResource.class.getSimpleName());
	
	@Autowired
	private FileService service;
	
	@RequestMapping(value = "/insert", method = RequestMethod.POST)
	public ResponseEntity<Void> insert(@Valid @RequestBody FileNewDTO objDto) {
		File file = service.fromDTO(objDto);
